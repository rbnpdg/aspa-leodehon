...
<aside id="sidebar"
    ...
    <nav class="mt-8 px-4 space-y-2">
        ...
        @auth
            @if (auth()->user()->inInstitution('airlangga'))
                <a href="{{ route('sso.airlangga') }}" class="sidebar-link flex items-center px-4 py-2 text-gray-600 rounded-lg hover:bg-gray-100">
        ...
        <a  href="{{ route('logout') }}"
            class="sidebar-link sidebar-link-logout flex items-center px-4 py-2
