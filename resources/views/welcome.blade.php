...
@section('content')
    <section id="beranda" class="relative z-0 text-white h-[32rem] sm:h-[36rem] md:h-[40rem] lg:h-[44rem] xl:h-[48rem]">
        ...
        <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
            <h1 class="text-4xl md:text-6xl font-bold mb-6" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="space-x-4">
                <a href="#fasilitas" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary transition-colors duration-200" data-aos="fade-up" data-aos-delay="500">
    ...
    <section id="fasilitas" class="py-20 bg-gray-100 scroll-mt-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" data-aos="zoom-in" data-aos-delay="100">Fasilitas</h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto" data-aos="zoom-in" data-aos-delay="300">
                    Nikmati berbagai fasilitas yang mendukung produktivitas dan pengembangan diri
                </p>
            </div>
    ...
    <section id="kegiatan" class="py-20 bg-white scroll-mt-14">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" data-aos="zoom-in" data-aos-delay="100">Kegiatan Harian Asrama</h2>
                <p class="text-lg text-gray-600" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-gray-800" data-aos="zoom-in" data-aos-delay="500">
    ...
    <section id="visi-misi" class="py-20 bg-gray-100 scroll-mt-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" data-aos="zoom-in" data-aos-delay="100">Visi & Misi</h2>
            </div>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div class="bg-white rounded-lg shadow-lg p-8 h-full" data-aos="fade-right" data-aos-delay="300">
                ...
                <div class="bg-white rounded-lg shadow-lg p-8" data-aos="fade-left" data-aos-delay="500">
                    <div class="text-center mb-6">
                        <div class="bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
    ...
    <section id="sejarah" class="py-20 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10">
                <h2 class="text-3xl text-center md:text-4xl font-bold text-gray-900 mb-10" data-aos="zoom-in" data-aos-delay="100">Sejarah Asrama</h2>
                <p class="text-lg text-gray-700 text-justify  max-w-3xl mx-auto leading-relaxed" data-aos="zoom-in" data-aos-delay="300">
